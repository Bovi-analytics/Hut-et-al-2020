...
write.csv2(Week8Data, file="../Data/Week8Data.csv", na="", dec = ".", row.names = FALSE)
```
...
Model1.8 <- glmer(formula = LocomotionScore ~ DryPeriodLengthCat +  
                     (1|HerdIdentifier),
                   data = Week8Data,
                   family = binomial(link = logit),
                   control=glmerControl(optimizer="bobyqa",
...
Model2.5 <- glmer(formula = LocomotionScore ~ Parity + CalvingSeason + 
                   ...
                   control=glmerControl(optimizer="bobyqa",
                                        optCtrl=list(maxfun=2e5)))
Model2.6 <- glmer(formula = LocomotionScore ~ Parity + CalvingSeason + 
                    DryPeriodLength + 
                    (1 | HerdIdentifier),
                   data = Week8Data,
                   family = binomial(link = logit),
...
anova(Model2.0, Model2.1, Model2.2, Model2.3, Model2.4, Model2.5, Model2.6, test = "Chisq")
```
