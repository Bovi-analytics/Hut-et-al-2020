---
title: "Association locomotion score 1-2 vs 3-5 on Week 8 with BCS"
output: 
  github_document:
    toc: true
    toc_depth: 3
...
Model1.11 <- glmer(formula = LocomotionScore ~ HerdIdentifier +  
                     (1|HerdIdentifier),
                   data = Week8Data,
                   family = binomial(link = logit),
                   control=glmerControl(optimizer="bobyqa",
...
print("Variance inflation model")
vif.mer(Model2.0)
```
